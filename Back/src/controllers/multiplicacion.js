...
const MultiplicacionRepository = AppDataSource.getRepository(Multiplicacion);

const multiplicacionController = async (req, res) => {
  ...
  try {
    ...
    const nuevaMultiplicacion = MultiplicacionRepository.create({
      prop1: num1,
      prop2: num2,
      resultado: resultado,
    });
    await queryRunner.manager.save(nuevaMultiplicacion);
...
export default multiplicacionController;
